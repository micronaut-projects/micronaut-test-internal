...
Sign the [Contributor License Agreement (CLA)](https://cla-assistant.io/micronaut-projects/micronaut-test-internal). This is required before any of your code or pull-requests are accepted.
...
Micronaut test-internal currently requires JDK 21.

## IDE Setup

Micronaut test-internal can be imported into IntelliJ IDEA by opening the `build.gradle` file.

## Docker Setup

Micronaut test-internal tests currently require Docker to be installed.

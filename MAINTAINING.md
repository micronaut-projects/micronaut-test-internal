...
We have a [template repo](https://github.com/micronaut-projects/micronaut-test-internal) that we use as the single
...
[Release GitHub Action workflow](https://github.com/micronaut-projects/micronaut-test-internal/blob/master/.github/workflows/release.yml)
